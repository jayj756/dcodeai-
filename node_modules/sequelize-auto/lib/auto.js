...
class SequelizeAuto {
    ...
    build() {
        const builder = new auto_builder_1.AutoBuilder(this.sequelize, this.options.tables, this.options.skipTables, this.options.schema);
