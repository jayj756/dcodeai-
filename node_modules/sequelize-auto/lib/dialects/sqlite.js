...
exports.sqliteOptions = {
    ...
    countTriggerQuery: (tableName, schemaName) => {
        return `SELECT COUNT(0) AS trigger_count
              FROM sqlite_master
             WHERE type = 'trigger'
               AND tbl_name = ${dialect_options_1.addTicks(tableName)}`;
    },
    /**
     ...
     */
    isSerialKey: (record) => {
        return (lodash_1.default.isObject(record) && exports.sqliteOptions.isPrimaryKey(record) && (record.type === 'INTEGER'));
    },
};
